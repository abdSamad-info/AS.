    ...
    <section id="experience" aria-labelledby="experience-heading" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <h3 id="experience-heading" className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">
            Experience & Journey
          </h3>
        ...
        {isLoading ? (
          <div aria-busy="true" aria-label="Loading professional track and experience..." className="space-y-12 animate-pulse">
            {/* Skeleton Position 1 */}
            <div className="relative pl-8 sm:pl-12 border-l border-white/10">
              <div className="absolute -left-3.5 top-0 w-7 h-7 bg-white/10 rounded-full border-4 border-[#08090e] skeleton-shimmer" />
              <div className="glass p-6 sm:p-8 rounded-3xl border-white/10">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-6 border-b border-white/5">
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="h-4 w-36 bg-white/5 rounded-md skeleton-shimmer" />
                    </div>
                    <div className="h-7 w-56 bg-white/10 rounded-xl skeleton-shimmer" />
                    <div className="h-4 w-32 bg-white/5 rounded-md skeleton-shimmer" />
                  </div>
                  <div className="h-8 w-44 bg-white/5 rounded-full skeleton-shimmer" />
                </div>

                <div className="space-y-4">
                  <div className="h-3 w-full bg-white/5 rounded skeleton-shimmer" />
                  <div className="h-3 w-11/12 bg-white/5 rounded skeleton-shimmer" />
                  <div className="h-3 w-4/5 bg-white/5 rounded skeleton-shimmer" />
                  <div className="h-3 w-5/6 bg-white/5 rounded skeleton-shimmer" />
            ...
            <div className="relative pl-8 sm:pl-12 border-l border-white/10">
              ...
              <div className="glass p-6 sm:p-8 rounded-3xl border-white/5">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 pb-6 border-b border-white/5">
                  <div className="space-y-2">
                    <div className="h-6 w-48 bg-white/10 rounded-xl skeleton-shimmer" />
                    <div className="h-4 w-40 bg-white/5 rounded-md skeleton-shimmer" />
                  </div>
                  <div className="h-8 w-36 bg-white/5 rounded-full skeleton-shimmer" />
                </div>
